const translation = {
  ...
  welcome: 'Bem-vindo ao Transbordo[AI], faça login para continuar.',
  ...
  joinTipEnd: 'equipe no Transbordo[AI]',
  invalid: 'O link expirou',
  explore: 'Explorar o Transbordo[AI]',
